...
tsNode.register({
    ...
    compilerOptions: Object.assign(Object.assign({}, readConfig(path.join(__dirname, "typescript/tsconfig.common.json"))
        .compilerOptions), readConfig(path.join(__dirname, "tsconfig.json")).compilerOptions),
